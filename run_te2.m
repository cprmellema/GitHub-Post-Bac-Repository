...
%Model 37 fits TE over a longer set of training data and includes all
%recordings from that day, including the second manual recording
modelID = 37;
blackrock = './blackrock/';
labviewpath = './labview/';
...
for idx = 1:108
	...
	if ~strcmp(MCnevfile1, 'null') & ~strcmp(MCnevfile2, 'null') & ~strcmp(BCnevfile1, 'null') & ~strcmp(DCnevfile, 'null')
		...
		processTEtoolbox2(conn, modelID, blackrock, labviewpath, MCnevfile1, BCnevfile1, MCnevfile2, DCnevfile, expt_id, paramcode);
	else
