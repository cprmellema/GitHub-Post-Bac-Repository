...
% addpath('F:\Post-Bac\GitHub-Post-Bac-Repository\queryMySQL\queryMySQL\src')
% javaaddpath('F:\Post-Bac\GitHub-Post-Bac-Repository\queryMySQL\queryMySQL\lib\mysql-connector-java-5.1.6');
% javaclasspath
% import edu.stanford.covert.db.MySQLDatabase;
% db = MySQLDatabase('fairbanks.amath.washington.edu:3306', 'spanky_db', 'cprmellema', 'Artist13');
...
figure
[fBCIin,xiBCIin] = ksdensity(dcotuned, 'width', 0.00003, 'npoints', 600);
[fnBCIin,xinBCIin] = ksdensity(dother, 'width', 0.00003, 'npoints', 600);
plot(xiBCIin,fBCIin, xinBCIin,fnBCIin);
xlabel('MCTE - BCTE')
ylabel('Density')
xlim([-0.0005 0.0005])
legend('Cotuned with BC-unit', 'Randomly selected unit')
saveplot(gcf, './TE-decoupling-MC-BC.eps')
saveplot(gcf, './TE-decoupling-MC-BC.jpg','jpg')
...
xlim([-0.0005 0.0005])
legend('Cotuned with BC-unit', 'Randomly selected unit')
saveplot(gcf, './TE-decoupling-MC-DC.eps')
saveplot(gcf, './TE-decoupling-MC-DC.jpg','jpg')